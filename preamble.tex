...
% Create a flag, fancyfonts. If this is set to false, Arno, Gill Sans and
...
\iftoggle{fancyfonts}{%
  ...
  % fallback for the rest. All macros are from unicode-math.
  ...
  \setmathfont{Arno Pro}[range={up/{num,latin,Latin,greek,Greek},
    ...
    \times,\lbrace,\rbrace,\div}] % Missing \lbrack, \rbrack
  ...
  % Set Gill Sans as the sf math font.
