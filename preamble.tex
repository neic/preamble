...
%\listfiles
\documentclass[a4paper,12pt,twoside,article,table,english,draft]{memoir}[2015/07/08]
...
%%% Colors and graphics %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{xxcolor} % xxcolor is an extension for for xcolor which is color.
                     % xxcolor is shipped with pgf.
